...
import ua.october.models.Person;
...
public class PersonDAO {
    ...
    public void testMultipleUpdate() {
        ...
        for (Person person : people) {
            jdbcTemplate.update("INSERT INTO Person(name, age, email) VALUES( ?, ?, ?, ?)", person.getId(), person.getName(), person.getAge(),
                    person.getEmail());
        }
